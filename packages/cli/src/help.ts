...
export function commandHelp(command: string): string {
	const usage: Record<string, string> = {
		...
		search:
			"Usage: astrograph search <query> [-l 10] [-k kind] [--lang lang] [--no-generated] [-j]",
		query:
			"Usage: astrograph query <query> [-l 10] [-k kind] [--lang lang] [--no-generated] [-j]",
		q: "Usage: astrograph q <query> [-l 10] [-k kind] [--lang lang] [--no-generated] [-j]",
		context:
			"Usage: astrograph context <task> [-n 20] [--no-code] [--budget tokens] [-f markdown|json]",
		trace: "Usage: astrograph trace <from> <to> [-d maxDepth] [-j]",
		callers:
			"Usage: astrograph callers <symbol> [-l 20] [--include-external] [-j]",
		callees:
			"Usage: astrograph callees <symbol> [-l 20] [--include-external] [-j]",
		impact:
			"Usage: astrograph impact <symbol> [-d 2] [--include-external] [-j]",
		node: "Usage: astrograph node <symbol> [-c] [-j]",
		explore: "Usage: astrograph explore <terms...> [--max-files 12] [-j]",
		files:
			"Usage: astrograph files [--filter dir] [--pattern glob] [--format tree|flat|grouped] [-j]",
